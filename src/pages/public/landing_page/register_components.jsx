      ...
      <form onSubmit={handleSubmit}>
        ...
        <section>
          <div className="mb-4 font-semibold text-lg flex items-center">
            <h1 className="w-2/5 max-w-fit mr-3">Organization Information</h1>
            <hr className="w-full" />
          </div>
          <div className="grid grid-cols-6 gap-x-2 gap-y-1">
            ...
            <div className="flex flex-col gap-1 col-span-2">
              <label htmlFor="organizationAcronym">Organization Acronym</label>
              <input
                type="text"
        ...
        {/* Submit */}
        <div className="w-full mt-2 gap-4 flex justify-end">
          <Submitbutton />
        </div>
        <hr className="w-full my-4" />
      </form>
  ...
  return (
    <section>
      <div className="font-semibold text-lg flex items-center mb-4">
        <h1 className="w-2/5 max-w-fit mr-3">Upload Files</h1>
        <hr className="w-full" />
      </div>
      <form onSubmit={onSubmit} className="p-4 space-y-4">
        <ReusableFileUpload fields={fields} onFileChange={handleFileChange} />
  ...
  return (
    <section className="mt-4">
      ...
      <section className="mb-6">
        <h2 className="text-md font-semibold mb-2">Organization Information</h2>
      ...
      {/* Adviser Info */}
      <section className="mb-6">
        <h2 className="text-md font-semibold mb-2">Adviser Information</h2>
        <div className="grid grid-cols-2 gap-4 text-sm">
          <p>
